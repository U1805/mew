...
func DownloadAttachmentBytes(ctx context.Context, mewHTTPClient, externalHTTPClient *http.Client, apiBase, userToken string, att sdkapi.AttachmentRef, limit int64) ([]byte, error) {
	if limit <= 0 {
