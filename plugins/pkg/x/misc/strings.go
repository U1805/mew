...
//  3. caller source file directory (outside plugins/pkg)
func CandidateDataFilePaths(filename string) []string {
	...
	if _, file, _, ok := runtime.Caller(callerx.NonSDKCallerSkip(2)); ok && strings.TrimSpace(file) != "" {
